...
def predict_price(year,town,flat_type,flr_area_sqm,flat_model,
                    stry_start,stry_end,re_les_year,
    ...
    with open("ResaleFlatPrices_model_1.pkl","rb") as f:
...
st.title("SINGAPORE RESALE FLAT PRICES PREDECTING")
st.write("")
...
if select == "Home":
    img=Image.open("S:/singapore flat analysis/maxresdefault.jpg")
    st.image(img)
